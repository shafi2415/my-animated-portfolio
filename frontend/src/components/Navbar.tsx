    ...
    >
      ...
      >
        ...
        <div className="relative liquid-glass rounded-2xl px-6 py-2.5 flex items-center gap-8">
          ...
          <a
            href="#home"
            className="text-sm font-semibold text-white/90 tracking-tight hover:text-white transition-colors whitespace-nowrap"
          >
            My Portfolio.
          </a>
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              className="relative liquid-glass rounded-2xl mt-2 px-6 py-4 md:hidden w-full"
            >
